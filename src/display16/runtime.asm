...
; V9xGmadrFill was removed on 2026-09-15. The GPU fills its own render
; target with an XY_COLOR_BLT now, and the CPU does not write that memory
; at all - a condition of the Phase 5 errata gate opening. A bulk-store
; primitive that nothing calls is worse than none: it is a loaded weapon
; with the safety catch in a different file.
ENDIF
