...
static void v9x_d3d_virge_describe_caps(V9X_DD_SHARED *shared)
{
    ...
    shared->d3d_extended_caps.dwMinTextureWidth = v9x_d3d_virge_limits.texture_size_min;
    shared->d3d_extended_caps.dwMaxTextureWidth = v9x_d3d_virge_limits.texture_size_max;
    shared->d3d_extended_caps.dwMinTextureHeight = v9x_d3d_virge_limits.texture_size_min;
    shared->d3d_extended_caps.dwMaxTextureHeight = v9x_d3d_virge_limits.texture_size_max;
...
static int v9x_d3d_virge_accepts(const V9X_R3D_DRAW *draw)
{
    ...
    /* An explicit draw's CPU texture, scissor or channel mask: none of them
     * is anything the S3D setup here programs. */
