...
@{
    ...
    SceneCombinedCrc = '0DF1CA4C'
    SceneArmCrc = '8152A800'
    SceneTotalProbes = 37
    TextureQuadrants = @(
        '1C3E'
        'F325'
    ...
    Scenes = @(
        ...
        @{
            ...
            Depth = $false
            Colors = @(
                @{ Value = 'F800'; Measured = $false }
            )
            Probes = @(
                @{ Name = 'GrdNearA'; X = 80; Y = 80; Expect = 25 }
                @{ Name = 'GrdNearB'; X = 560; Y = 80; Expect = 25 }
                @{ Name = 'GrdNearC'; X = 320; Y = 430; Expect = 25 }
                @{ Name = 'GrdCentre'; X = 320; Y = 192; Expect = 25 }
        ...
        @{
            ...
            Colors = @(
                @{ Value = '1C3E'; Measured = $true }
                @{ Value = 'F325'; Measured = $false }
            )
            Probes = @(
                @{ Name = 'BlnUnder'; X = 100; Y = 60; Expect = 1 }
                @{ Name = 'BlnOver0'; X = 200; Y = 60; Expect = 24 }
                @{ Name = 'BlnOver1'; X = 150; Y = 30; Expect = 24 }
                @{ Name = 'BlnFill'; X = 280; Y = 60; Expect = 24 }
                @{ Name = 'BlnOut'; X = 560; Y = 220; Expect = 0 }
            )
        }
    )
    ReferencePixels = @(
