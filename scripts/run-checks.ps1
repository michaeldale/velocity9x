...
Invoke-CheckStep "Intel GTT capture validator" {
    & (Join-Path $PSScriptRoot "check-intel-gtt-capture.ps1") -SelfTest
}

Invoke-CheckStep "Intel event capture validator" {
...
Invoke-CheckStep "Intel Phase 4 arm script" {
