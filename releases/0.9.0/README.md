...
Built from commit `b456699`: the output of
...
| --- | --- | --- | --- |
| [`velocity9x-0.9.0-ati.zip`](velocity9x-0.9.0-ati.zip) | ATI Mach64 / Rage | `PCI\VEN_1002&DEV_4C4D<br>PCI\VEN_1002&DEV_5654` | HOST-AUDITED; GUEST ACTIVATION NOT YET TESTED |
| [`velocity9x-0.9.0-intel-gma.zip`](velocity9x-0.9.0-intel-gma.zip) | Intel GMA (Gen3) | `PCI\VEN_8086&DEV_27AE` | HOST-AUDITED; GUEST ACTIVATION NOT YET TESTED |
| [`velocity9x-0.9.0-matrox-m2.zip`](velocity9x-0.9.0-matrox-m2.zip) | Matrox Millennium II | `PCI\VEN_102B&DEV_0519<br>PCI\VEN_102B&DEV_051B` | HOST-AUDITED; PHYSICAL ACTIVATION NOT YET TESTED |
| [`velocity9x-0.9.0-s3.zip`](velocity9x-0.9.0-s3.zip) | S3 | `PCI\VEN_5333&DEV_8810<br>PCI\VEN_5333&DEV_8811<br>PCI\VEN_5333&DEV_8812<br>PCI\VEN_5333&DEV_8813<br>PCI\VEN_5333&DEV_8814<br>PCI\VEN_5333&DEV_8901<br>PCI\VEN_5333&DEV_8A01<br>PCI\VEN_5333&DEV_8A13` | HOST-AUDITED; GUEST ACTIVATION NOT YET TESTED |
| [`velocity9x-0.9.0-vbe.zip`](velocity9x-0.9.0-vbe.zip) | VBE tier-0 (generic VESA) | `PCI\VEN_1234&DEV_1111` | HOST-AUDITED; GUEST ACTIVATION NOT YET TESTED |
...
[`velocity9x-survey-0.9.0.zip`](velocity9x-survey-0.9.0.zip) - a real-mode DOS program that reads
