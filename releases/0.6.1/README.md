...
Built from commit `e938fdc`: the output of
...
| --- | --- | --- | --- |
| [`velocity9x-0.6.1-ati.zip`](velocity9x-0.6.1-ati.zip) | ATI Mach64 / Rage | `PCI\VEN_1002&DEV_4C4D<br>PCI\VEN_1002&DEV_5654` | HOST-AUDITED; GUEST ACTIVATION NOT YET TESTED |
| [`velocity9x-0.6.1-matrox-m2.zip`](velocity9x-0.6.1-matrox-m2.zip) | Matrox Millennium II | `PCI\VEN_102B&DEV_051B` | HOST-AUDITED; PHYSICAL ACTIVATION NOT YET TESTED |
| [`velocity9x-0.6.1-s3.zip`](velocity9x-0.6.1-s3.zip) | S3 | `PCI\VEN_5333&DEV_8811<br>PCI\VEN_5333&DEV_8A01` | HOST-AUDITED; GUEST ACTIVATION NOT YET TESTED |
| [`velocity9x-0.6.1-vbe.zip`](velocity9x-0.6.1-vbe.zip) | VBE tier-0 (generic VESA) | `PCI\VEN_1234&DEV_1111` | HOST-AUDITED; GUEST ACTIVATION NOT YET TESTED |
...
[`velocity9x-survey-0.6.1.zip`](velocity9x-survey-0.6.1.zip) - a real-mode DOS program that reads
