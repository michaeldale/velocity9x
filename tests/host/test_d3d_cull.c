...
#include "../../src/display32/d3d/d3d_cull.h"
...
{
    return v9x_d3d_cull_triangle(mode, t[0], t[1], t[2], t[3], t[4], t[5]);
}
...
static void test_values_match_d3dtypes(void)
{
    ...
    static const unsigned long values[3] = {
        V9X_D3DCULL_NONE, V9X_D3DCULL_CW, V9X_D3DCULL_CCW
    };
    unsigned int index;
...
{
    CCHECK(culled(V9X_D3DCULL_NONE, cw_tri) == 0);
    CCHECK(culled(V9X_D3DCULL_NONE, ccw_tri) == 0);
}

static void test_cull_cw_removes_clockwise_only(void)
{
    CCHECK(culled(V9X_D3DCULL_CW, cw_tri) == 1);
    CCHECK(culled(V9X_D3DCULL_CW, ccw_tri) == 0);
}

static void test_cull_ccw_removes_counterclockwise_only(void)
{
    CCHECK(culled(V9X_D3DCULL_CCW, ccw_tri) == 1);
    CCHECK(culled(V9X_D3DCULL_CCW, cw_tri) == 0);
}

/* Winding is a property of the cycle, not of which vertex comes first. */
static void test_rotation_keeps_winding(void)
{
    CCHECK(v9x_d3d_cull_triangle(V9X_D3DCULL_CW,
                                 50.0f, 10.0f, 10.0f, 50.0f,
                                 10.0f, 10.0f) == 1);
    CCHECK(v9x_d3d_cull_triangle(V9X_D3DCULL_CCW,
...
{
    CCHECK(v9x_d3d_cull_honoured(V9X_D3DCULL_CCW, 0, 0) == V9X_D3DCULL_NONE);
    CCHECK(v9x_d3d_cull_honoured(V9X_D3DCULL_CW, 0, 0) == V9X_D3DCULL_NONE);
    CCHECK(v9x_d3d_cull_honoured(V9X_D3DCULL_CCW, 1, 0) == V9X_D3DCULL_NONE);
    CCHECK(v9x_d3d_cull_honoured(V9X_D3DCULL_CW, 0, 1) == V9X_D3DCULL_NONE);
    CCHECK(v9x_d3d_cull_honoured(V9X_D3DCULL_CW, 1, 0) == V9X_D3DCULL_CW);
    CCHECK(v9x_d3d_cull_honoured(V9X_D3DCULL_CCW, 0, 1) == V9X_D3DCULL_CCW);
    CCHECK(v9x_d3d_cull_honoured(V9X_D3DCULL_NONE, 1, 1) == V9X_D3DCULL_NONE);
    CCHECK(v9x_d3d_cull_honoured(9ul, 1, 1) == V9X_D3DCULL_NONE);
}
