...
| Close Direct3D compatibility holes | The target switch and the primary-chain blend are both closed as probe artefacts - an uncleared depth buffer - so what remains is Incoming's requested texture format, the Trio3D blend state, and two devices at once | [Refutation](decisions/2026-09-10-the-render-target-switch-and-the-uncleared-depth-buffer.md), [Incoming](issues/2026-09-05-incoming-refuses-the-hal-texture-formats.md), [latest blend investigation](decisions/2026-09-05-a-register-capture-of-both-trio3d-blend-states.md), [two devices](issues/2026-09-04-a-second-d3d-device-on-the-primary-chain-kills-the-caller.md) |
